...
use App\Jobs\BulkClientApisRegistration;
...
class ClientController extends Controller
{
    ...
    public function BulkRegisterClientApiServerURL(Request $req)
    {
        ...
        if ($req->hasFile('excel_file')) {
            ...
            BulkClientApisRegistration::dispatch($filePath);
          return response()->json(["message" => "ApiServerUrl registered for all the Clients"], 200);
